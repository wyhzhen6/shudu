...
void writeFile(vector<Board> boards, ofstream& f,int num)
{
...
void generateGame(int gameNumber, int gameLevel, vector<int> digCount, ofstream& outfile, SudokuMaker& maker, bool isonly)
{
